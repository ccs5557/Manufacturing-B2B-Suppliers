    ...
    <section className="relative h-[100svh] min-h-[620px] w-full overflow-hidden bg-surface lg:h-[860px] lg:min-h-0">
      ...
      <div className="relative z-10 flex h-full flex-col justify-start px-5 pt-24 lg:justify-center lg:px-14 lg:pt-0">
        <div className="max-w-[720px]">
          ...
          <h1 className="mt-5 font-display font-bold uppercase leading-[0.94] tracking-[-0.025em]">
            {HEADLINE.map((line) => (
              <span
                ...
                data-hero=""
                data-shine=""
                className="headline-metal block text-[clamp(2.6rem,11vw,6.25rem)]"
              >
                {line}
              </span>
            ))}
          ...
          <p
            className="mt-6 max-w-[460px] font-body text-[15px] leading-[1.5] text-ink-2 lg:text-base"
            data-hero=""
          >
      ...
      {/* Trusted strip */}
      <div
        className="absolute inset-x-0 bottom-7 z-10 flex flex-col gap-3 px-5 lg:bottom-9 lg:px-14"
        data-hero=""
      >
